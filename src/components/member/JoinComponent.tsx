...
const JoinComponent = () => {
  ...
  const handleClickJoin = (formData: JoinForm) => {
    ...
    <div className="w-1/2 border-2 border-sky-200 mt-10 m-2 p-4">
      ...
      <div className="flex justify-center">
        <div className="relative mb-4 w-full items-stretch">
          ...
          ></input>
          {errors.email && (
            <p role="alert" className="w-full p-3 text-red-500">
      ...
      <div className="flex justify-center">
        {/* <div className="relative mb-4 flexflex w-full flex-wrap justify-center"> */}
