...
const ResultModal = ({ title, content, callbackFn }: ResultModalProps) => {
  return (
    <div
    ...
    >
      <div className="absolute bg-white shadow dark:bg-gray-700 opacity-100 w-1/4 rounded mt-10 mb-10 px-6 min-w-[600px]">
        <div className="justify-center bg-warning-400 mt-6 mb-6 text-2xl border-b-4 border-r-gray-500">
          {title}
        </div>
        <div className="tx4xl border-orange-400 border-b-4 pt-4 pb-4">
          {content}
        </div>
