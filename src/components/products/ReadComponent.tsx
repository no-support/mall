...
import { ProductReadComponentProps, SimpleProduct } from "types";

const initState:SimpleProduct ={
  pno: 0,
  pname: "",
  price: 0,
  pdesc: "",
...
const ReadComponent = ({ pno }:ProductReadComponentProps) => {
  ...
  const handleClickAddCart = () => {
    ...
    // const parsedPno = parseInt(pno);
    // if parsedPno
    changeCart({ email: loginState.email, pno: pno, qty: qty });
  };

  const product = data as SimpleProduct  || initState;
    ...
    <div className="border-2 border-sky-200 mt-10 m-2 p-4">
      ...
      <div className="flex justify-end p-4">
        ...
        <button
          ...
          onClick={() => moveToModify(pno.toString())}
        >
          Modify
        </button>
        <button
